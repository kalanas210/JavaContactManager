...
public class DeleteContact extends JFrame {
    ...
    private static int delete_index=0;
    ...
    DeleteContact() {
        ...
        JLabel header = new JLabel("DELETE CONTACT", SwingConstants.CENTER);
        ...
        //left_panel.setBorder(new EmptyBorder(80, 0, 80, 0));
        ...
        JButton addcontact = new JButton("Delete Contact");
        addcontact.setFont(new Font("Arial", Font.BOLD, 16));
        addcontact.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                int option = JOptionPane.showConfirmDialog(null,"Are you sure to delete this contact ?", "Delete", option=JOptionPane.YES_NO_OPTION);
                if(option == JOptionPane.YES_OPTION){
					ContactController.deleteContacts(delete_index);
					int lastoption = JOptionPane.showConfirmDialog(null, "Contact Delete Successfully...Do You Want to Delete another Contact ?", "Success", lastoption=JOptionPane.YES_OPTION,JOptionPane.NO_OPTION);
					if(lastoption == JOptionPane.NO_OPTION){
					...
					int lastoption = JOptionPane.showConfirmDialog(null, "Contact Not Deleted ! Do You Want to Delete another Contact ?", "Error", lastoption=JOptionPane.YES_OPTION,JOptionPane.NO_OPTION);
					if(lastoption == JOptionPane.NO_OPTION){
						dispose();
                        id.setText("");
                        searchtxt.setText("");
