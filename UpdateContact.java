...
public class UpdateContact extends JFrame {
    ...
    UpdateContact() {
        ...
        JLabel header = new JLabel("UPDATE CONTACT", SwingConstants.CENTER);
        ...
        JButton addcontact = new JButton("Update Contact");
        ...
        addcontact.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt){
                ...
                if(!isValidPhoneNumber){
					...
					ContactController.UpdateContact(id1, name1, phone1, company1, salary1, birthday1, update_index);
					//ContactController.contactID++;
					
					int lastoption = JOptionPane.showConfirmDialog(null, "Contact Update Successfully...Do You Want to Update another Contact ?", "Error", lastoption=JOptionPane.YES_OPTION,JOptionPane.NO_OPTION);
